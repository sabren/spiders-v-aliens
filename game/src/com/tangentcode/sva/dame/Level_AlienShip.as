...
import com.tangentcode.sva.*;
	public class Level_AlienShip extends BaseLevel
	{
		...
		public function Level_AlienShip(addToStage:Boolean = true, onAddCallback:Function = null)
		{
			...
			layerOutside = addTilemap( CSV_Outside, Img_Outside, -800.000, -1000.000, 40, 50, 0.250, 0.250, false, 100, 1, properties, onAddCallback );
			properties = generateProperties( null );
		...
		{
			addSpriteToLayer(null, Alien, MobilesGroup , 80.000, 1119.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			...
			addSpriteToLayer(null, Box, MobilesGroup , 304.000, 820.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 272.000, 820.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 288.000, 820.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			...
			addSpriteToLayer(null, Box, MobilesGroup , 96.000, 820.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			...
			addSpriteToLayer(null, Box, MobilesGroup , 1104.000, 780.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			...
			addSpriteToLayer(null, Box, MobilesGroup , 1392.000, 780.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			...
			addSpriteToLayer(null, Box, MobilesGroup , 1168.000, 800.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1184.000, 800.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1200.000, 800.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			...
			addSpriteToLayer(null, Box, MobilesGroup , 1328.000, 840.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1344.000, 840.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1152.000, 1180.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1152.000, 1160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1168.000, 1160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1168.000, 1180.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1376.000, 1080.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1392.000, 1080.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1376.000, 1100.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			addSpriteToLayer(null, Box, MobilesGroup , 1392.000, 1100.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Box"
			...
			addSpriteToLayer(null, Alien, MobilesGroup , 1328.000, 1080.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Alien, MobilesGroup , 1216.000, 1160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Alien, MobilesGroup , 1264.000, 1120.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Alien, MobilesGroup , 1328.000, 780.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			...
			addSpriteToLayer(null, Alien, MobilesGroup , 96.000, 800.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Alien, MobilesGroup , 288.000, 800.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			...
			addSpriteToLayer(null, Portal, MobilesGroup , 3728.000, 160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"portalId", value:0 }, { name:"portalTo", value:0 }, { name:"hasPower", value:true }, null ), onAddCallback );//"Portal"
			addSpriteToLayer(null, Portal, MobilesGroup , 3536.000, 220.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"portalId", value:0 }, { name:"portalTo", value:0 }, { name:"hasPower", value:true }, null ), onAddCallback );//"Portal"
			addSpriteToLayer(null, Alien, MobilesGroup , 3648.000, 220.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Spider, MobilesGroup , 3648.000, 180.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Spider"
			addSpriteToLayer(null, Spider, MobilesGroup , 3616.000, 180.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Spider"
			addSpriteToLayer(null, Alien, MobilesGroup , 3648.000, 140.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Alien, MobilesGroup , 3616.000, 140.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
			addSpriteToLayer(null, Alien, MobilesGroup , 3616.000, 220.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( { name:"startDead", value:false }, null ), onAddCallback );//"Alien"
		...
		public function addSpritesForLayerMachinery(onAddCallback:Function = null):void
		{
			...
			addSpriteToLayer(null, Cannon, MachineryGroup , 64.000, 1160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Cannon"
			...
			addSpriteToLayer(null, HeartBox, MachineryGroup , 304.000, 1080.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"HeartBox"
			...
			addSpriteToLayer(null, HeartBox, MachineryGroup , 880.000, 440.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"HeartBox"
			addSpriteToLayer(null, Cannon, MachineryGroup , 1392.000, 1160.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Cannon"
			addSpriteToLayer(null, Cannon, MachineryGroup , 1152.000, 1080.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Cannon"
